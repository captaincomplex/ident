...
#
# Run on the Pi, after copying ident_4-4-0.zip to your home directory:
...
ZIP="${ZIP:-$HOME_DIR/ident_4-4-0.zip}"
...
[ -d "$NEW_APP/ident" ] || { echo "ERROR: $NEW_APP/ident missing. Copy ident_4-4-0.zip to $HOME_DIR first."; exit 1; }
